...
int main(void)
{
  ...
  /* definition and creation of seriais_Task */
...
/* USER CODE BEGIN Header_ble */
/**
* @brief Function implementing the ble_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ble */
void ble(void const * argument)
{
  /* USER CODE BEGIN ble */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_gpio */
/**
* @brief Function implementing the gpio_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_gpio */
void gpio(void const * argument)
{
...
* @retval None
*/
/* USER CODE END Header_seriais */
void seriais(void const * argument)
{
  /* USER CODE BEGIN seriais */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END seriais */
}
